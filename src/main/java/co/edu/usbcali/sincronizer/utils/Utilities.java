...
package co.edu.usbcali.sincronizer.utils;
...
public class Utilities {
	...
	public static boolean isOnlyLetters(String word) {
		...
		if(cleanWord.matches("[a-zA-Z]"+"{"+cleanWord.length()+"}")) {
			return true;
		}
		return false;
	}
	 ...
	 * 
	 * @Title: isEmpty   
	   * @Description: RETORNA SI UN STRING ES VACIO O NO 
	 * @param: @param param
	 * @param: @return      
	 * @return: boolean      
	 * @throws
	 ...
	 * 
	 * @Title: isLongerThan   
	   * @Description: PREGUNTA SI LA LÓNGITUD DE UN TEXTO ES MAYOR O  NO
	   * A UN NÚMERO ESPECÍFICADO
	 * @param: @param texto
	 * @param: @param number
	 * @param: @return      
	 * @return: boolean      
	 * @throws
	 */
	public static boolean isLongerThan(String texto, int number ) {
